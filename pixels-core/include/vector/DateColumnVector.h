...
class DateColumnVector : public ColumnVector {
  public:
    /*
     * They are the days from 1970-1-1. This is consistent with date type's
     * internal representation in Presto.
     */
    int *dates;
     ...
     */
    explicit DateColumnVector(uint64_t len = VectorizedRowBatch::DEFAULT_SIZE,
                              bool encoding = false);
    ~DateColumnVector();
